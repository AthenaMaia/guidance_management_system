            ...
            <div class="">
                <div class="bg-white rounded-lg shadow-lg p-6 space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        <h1 class="text-2xl font-bold text-red-700 mb-2">Counseling Records</h1>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                        <div class="flex flex-col lg:flex-row lg:items-end gap-4">
                            <!-- Filter Form -->
                            <form method="GET" class="flex flex-wrap gap-4 items-end flex-grow">
                                <!-- Status Filter -->
                    ...
                    <!-- Status Banner -->
                    @if(session('success'))
                        <div class="bg-green-50 border-l-4 border-green-500 p-4 rounded-md flex items-center">
                    ...
                    @if(session('warning'))
                        <div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-md flex items-center">
                            <div class="flex-shrink-0">
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                @forelse ($counselings as $counseling)
                                    ...
                                    <tr class="table-row-hover">
                                        <td class="px-4 py-3 font-medium text-gray-800">{{ $counseling->student->student_id }}</td>
                                        <td class="px-4 py-3">{{ $counseling->student->last_name }}, {{ $counseling->student->first_name }} {{ $counseling->student->middle_name }}. {{ $counseling->student->suffix }}</td>
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="status-badge {{ $counseling->status === 'Completed' ? 'completed-badge' : 'progress-badge' }}">
                                    ...
                                    <tr>
                                        <td colspan="8" class="px-4 py-6 text-center text-gray-500">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <button @click="openModal = true" class="mt-2 text-sm text-red-600 hover:underline">Add a new counseling record</button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
